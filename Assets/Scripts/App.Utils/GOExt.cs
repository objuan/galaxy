...
{
    public static T Instance<T>( Func<T,bool> cond) where T : UnityEngine.Object
    {
        return GameObject.FindObjectsByType<T>( FindObjectsSortMode.None).FirstOrDefault( X => cond(X)) ;
    }
