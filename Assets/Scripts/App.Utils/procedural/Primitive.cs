namespace ProceduralPrimitives
{
    ...
    public static partial class Primitive
    {
        ...
        /// <summary>
        /// Creates a <see cref="Mesh"/> filled with vertices forming a cylinder. Y is Height
        /// </summary>
        /// <remarks>
        /// The values are as follows:
        /// Vertex Count    = slices * (stacks + 1) + 2
        ...
        public static Mesh CreateCylinderMesh(float bottomRadius, float topRadius, float length, int slices, int stacks)
        {
            ...
            MeshData data = CreateCylinder(bottomRadius, topRadius, length, slices, stacks);
        ...
        public static MeshData CreateCylinder(float bottomRadius, float topRadius, float length, int slices, int stacks)
        {
            ...
            data.normals = cylinderNormals;
            data.uv = cylinderUVs;
            data.triangles = CreateIndexBuffer(vertexCount, indexCount, slices);
        ...
        public static GameObject CreatePlaneGameObjectNoCollider(float width, float depth, int widthDivisions, int depthDivisions)
        {
        ...
        public static GameObject CreatePlaneGameObject(float width, float height, int widthDivisions, int depthDivisions)
        {
            Mesh mesh = CreatePlaneMesh(width, height, widthDivisions, depthDivisions);
            ...
            //    MeshCollider collider = gameObject.AddComponent<MeshCollider>();
            //BoxCollider collider = gameObject.AddComponent<BoxCollider>();
            //collider.size = new Vector3(width,0.4f, height);
